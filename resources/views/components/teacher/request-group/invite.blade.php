<div class="col-12">
    <div class="card">
        ...
        @php
            ...
            $invite = DB::table('request_teacher')
        ...
        <div class="card-body table-responsive p-0" style="height: 300px;">
            <table class="table table-head-fixed text-nowrap">
                ...
                <tbody>
                    ...
                    <form action="{{route('Request_Group_Theacher.update',$Invites->id)}}" method="POST">
                        @csrf
                        @method('put')
                            <tr>
                                <td>{{ $Invites->id }}</td>
                                @php
                                    $sender = DB::table('users')->find($Invites->request_sender);
                                @endphp
